...
configuration = SwinConfig(num_channels=1, num_classes=1)
...
if not CFG.kaggle:
    output_path = './data/predictions/prediction-swin-bce' + current_date +'-'+ current_time+ '.csv'
    submission_df.to_csv('./data/predictions/prediction-swin-bce' + current_date +'-'+ current_time+ '.csv', index=False)
if CFG.kaggle:
