...
# ============== model CFG =============
    ...
    valid_id = 1
    batch=16 #128
    th_percentile = 0.00175 #0.00145 # 0.0014 #0.00175 #0.0021
    model_path=['/public/sist/home/hongmt2022/MyWorks/kaggle-bv/models/New_baseline/se_resnext50_32x4d_24_loss0.04_score0.92_val_loss0.25_val_score0.85_midd_rot002.pt']#  1024
